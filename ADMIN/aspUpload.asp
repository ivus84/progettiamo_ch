...
Class FreeASPUpload
    ...
    Public Sub Save(path)
        ...
        For Each fileItem In UploadedFiles.Items
            ...
            nomefile1=Replace(fileItem.FileName,".","")
            streamFile.SaveToFile path & nameprefix &hn& ext, 2
            streamFile.close
...
End Sub
    ...
    Private Sub Upload()
        ...
        if Err.Number <> 0 then
            response.write "<br><br><B>Il sistema non ha potuto eseguire la richiesta a causa del seguente errore:</B><p>"
            response.write Err.Description & "<p>"
            response.write "La causa piu' probabile e' una scorretta configurazione della variabile AspMaxRequestEntityAllowed nel MetaBase di IIS, impostato di default a 300 KB.<br/>Si consiglia di richiedere al proprio Hosting Provider di aumentare ilvalore di questa variabile</p>"
            Exit Sub
        end if
