...
<tr style="background-color:<%=colore%>"><td class="testoadm" style="padding:4px"> <a href="cantiere_utente.asp?ref1=<%=ref%>&sel2=<%=sel2%>" target="editing_page" onclick="setEditing();"><img src="images/edit.gif" border="0" style="float:right"/></a> <a href="del.asp?tabella=utenticantieri&pagina=<%=ref%>&da=cantieri_utenti"><img src="images/delete1.gif" border="0" style="float:right"/></a><b><%=cognome%></b> <%=nome%></td></tr>
